...
\begin{center}
\small Draft v3.0 (2026-08-27), circulated for author review before arXiv submission. Every quantitative claim below regenerates deterministically from frozen artifacts with a single command (\path{scripts/recompute_headline_numbers.py}, 70 of 70 PASS); bar arithmetic derives strictly from \path{results/verification/bar_ledger.json}. Companion study cited as Frias (2026), arXiv:2608.10216.
\end{center}
